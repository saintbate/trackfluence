...
- **[BRAND_CREATION.md](BRAND_CREATION.md)** – Brand creation feature  
- **[CHART_FEATURE.md](CHART_FEATURE.md)** – Revenue charts + tables  

## Data & Integration
- **[INGESTION_API.md](INGESTION_API.md)** – Shopify + GA4 import APIs  
- **SQL Migrations** – Located in `/sql` directory  

## Deployment
- **[docs/DEPLOY.md](docs/DEPLOY.md)** – Vercel / Railway / Docker deployment

## Monitoring
- **[docs/MONITORING.md](docs/MONITORING.md)** – Sentry setup + health checks  
